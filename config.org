...
(setq projectile-git-command "git ls-files -zco --exclude-standard -x \".ccls-cache\"")
...
**** Tweaking defaults
#+begin_src emacs-lisp
(setq org-directory (cl-find-if #'file-exists-p '("~/note/org/gtd" "~/Nextcloud/note/org/gtd"))                      ; let's put files here
...
#+begin_src emacs-lisp :noweb-ref none :tangle yes
(setq org-roam-directory (cl-find-if #'file-exists-p '("~/note/org/braindump/org" "~/Nextcloud/note/org/braindump/org")))
#+end_src
...
#+begin_src emacs-lisp :noweb-ref none :tangle (if (file-exists-p (cl-find-if #'file-exists-p '("~/note/org/braindump/org" "~/Nextcloud/note/org/braindump/org"))) "no" "packages.el")
